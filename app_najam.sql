...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2019 at 07:07 PM
...
INSERT INTO `mjesto` (`ID_mjesto`, `nazivMjesta`, `zupanija`) VALUES
(1, 'Mostar', 1),
(2, 'Grude', 3),
(3, 'Kupres', 2);
...
INSERT INTO `stan` (`ID_stan`, `id_vlasnik`, `adresa`, `brojKvadrata`, `brojSoba`, `cijena`, `id_mjesto`, `id_vrstaStana`) VALUES
...
ALTER TABLE `stan`
  ...
  ADD KEY `vrstaStana_fk` (`id_vrstaStana`),
...
--
ALTER TABLE `mjesto`
  MODIFY `ID_mjesto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `stan`
  ADD CONSTRAINT `stan_ibfk_1` FOREIGN KEY (`id_vlasnik`) REFERENCES `vlasnik` (`ID_vlasnik`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `stan_ibfk_2` FOREIGN KEY (`id_mjesto`) REFERENCES `mjesto` (`ID_mjesto`),
  ADD CONSTRAINT `stan_ibfk_3` FOREIGN KEY (`id_vrstaStana`) REFERENCES `vrstastana` (`ID_vrstaStana`);
